    ...
    return (
        <div className="min-h-screen">
            <div className="flex flex-col items-center min-h-screen pt-10 gap-4 pb-10">
                ...
                <p className="text-lg w-1/2 mt-4">
                ...
                <div className="flex flex-col items-center justify-center mt-6 bg-white rounded-lg shadow-lg p-6 w-1/2">
                    <h2 className="text-2xl mb-4 text-black">Follow us on Facebook!</h2>
                    <p className="text-lg mb-4 text-black w-1/2">We will be posting updates and information about the Expo on our <a className="text-blue-500 hover:text-blue-700" href="https://www.facebook.com/profile.php?id=61576173115948" target="_blank"   >Facebook page</a>. Make sure to follow us to stay updated!</p>
                    <h2 className="text-2xl mb-4 mt-6 text-black">Check out our latest post!</h2>
